...
import { PsychoJS } from '../../../lib/core-2020.1.js?v=4.0.0';
import * as core from '../../../lib/core-2020.1.js?v=4.0.0';
import { TrialHandler } from '../../../lib/data-2020.1.js?v=4.0.0';
import { Scheduler } from '../../../lib/util-2020.1.js?v=4.0.0';
import * as util from '../../../lib/util-2020.1.js?v=4.0.0';
import * as visual from '../../../lib/visual-2020.1.js?v=4.0.0';
import * as sound from '../../../lib/sound-2020.1.js?v=4.0.0';
...
function IAT_InstructionRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of IAT_InstructionComponents)
...
function upper_hintRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of upper_hintComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Step_InstructionRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of Step_InstructionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Condition_FeedbackRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of Condition_FeedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
